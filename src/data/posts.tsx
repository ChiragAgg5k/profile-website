export const posts = [
  ...
  },
  {
    ...
    thumbnail: "/blog/flow-forge.png",
    href: "https://dev.to/chiragagg5k/my-hackfrost-journey-navigating-development-challenges-with-daytona-hdc",
    publishedAt: "2024-12-05",
    tags: ["hackfrost", "daytona", "guide"],
    description:
      "A detailed guide on my journey with Hackfrost and Daytona, and how I used them to navigate development challenges.",
    links: [
      {
        icon: "💻",
        type: " dev.to",
