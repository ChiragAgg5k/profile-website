...
<BlogTitle slug="debugging-with-source-maps-a-comprehensive-guide" />
...
<OriginalPost
  text="Debugging with Source Maps: A Comprehensive Guide"
  link="https://dev.to/chiragagg5k/debugging-with-source-maps-a-comprehensive-guide-3dhp"
/>
