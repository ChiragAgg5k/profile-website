...
<BlogTitle slug="announcing-dev-keys" />

![Dev Keys](/images/blog/announcing-dev-keys/cover.png)
...
A new Appwrite feature that lets you bypass rate limits _during local development_. No more slowdowns. No more artificial blockers. Just fast, uninterrupted building.
...
<OriginalPost
  ...
  link="https://appwrite.io/blog/post/announcing-dev-keys"
/>
