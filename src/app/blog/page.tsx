...
const posts = [
  {
    ...
    icon: "📦",
    href: "https://www.freecodecamp.org/news/mastering-npm-a-comprehensive-guide-to-package-management-c2e0c8c9c0d2/",
    ...
    <section>
      <BlurFade delay={BLUR_FADE_DELAY}>
        ...
        <p className="mb-8">
          ...
          papers and journals, I also like to write them! Here you can find some of
          my favourite content related work published on various sites.
        </p>
      </BlurFade>
