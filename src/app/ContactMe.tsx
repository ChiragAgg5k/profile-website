...
export default function ContactMe() {
	return (
		<div className="mt-20 flex flex-col items-center justify-center bg-cyan-100 py-5 dark:bg-gray-800 sm:flex-row">
			<div className="min-w-1/2 flex flex-col justify-center sm:mr-10">
				<h2 className="cursor-default pb-8 pt-8 text-5xl sm:pt-0">
					Get in touch
				</h2>
			...
			<div className="flex w-full flex-col px-10 py-5 pt-10 sm:w-1/2 sm:px-0 sm:pl-10">
				<input
					type="text"
				...
				/>
				<button className="btn group relative mt-5 inline-flex h-12 w-40 items-center justify-start overflow-hidden rounded-lg border-2 bg-white text-sm transition-all dark:border-0 dark:bg-gray-900">
